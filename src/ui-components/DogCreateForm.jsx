...
export default function DogCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setSpecs(initialValues.specs);
    setLocation(initialValues.location);
    setMoney(initialValues.money);
    setTime(initialValues.time);
    setKeyColor(initialValues.keyColor);
    setErrors({});
  };
  const validations = {
    name: [{ type: "Required" }],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Dog(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "DogCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
